...
import com.nihal.paywise.util.LocaleHelper
...
class MainActivity : FragmentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val appLanguageFlow = (application as ExpenseTrackerApp).container.userPreferencesRepository.appLanguageFlow
        ...
        setContent {
            ...
            val appLanguage by appLanguageFlow.collectAsState(initial = "en")
